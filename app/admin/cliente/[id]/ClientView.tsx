...
export default function ClientView({ idPage, client, clientTypes, clientAddresses }: Params) {
    ...
    return (
        <div id="clientePerfil" className="box pb-10">
            {modal && (
                <div onMouseDown={closeModal} id="modal" className="fixed flex z-101 top-0 left-0 justify-center items-center h-dvh w-full bg-gray-600/80 md:backdrop-blur-xl">
