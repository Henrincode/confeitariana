...
export default function UpdateProfile({ closeModal, client }: { closeModal: Function, client: any }) {
    return(
        <div onClick={(e) => e.stopPropagation()} className="flex flex-col items-center gap-4 max-w-100 p-2 mx-auto rounded-2xl border-4 border-white text-white bg-pink-400">
