      ...
      <div className={styles.titulo + " container"}>
        <div className="box">
          ...
          <section className={styles['msg-contato']}>
                ...
                <p><i class="bi bi-whatsapp"></i> 19 9 8852-1020</p>
                <p><i class="bi bi-envelope"></i> confeitariana@gmail.com</p>
                <p><i class="bi bi-geo-alt"></i> 2000, Av. Comendador Thomaz Fortunato, Americana SP</p>
          </section>
