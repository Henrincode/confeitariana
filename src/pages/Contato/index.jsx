      ...
      <div className={styles.titulo + " container"}>
        <div className="box">
          ...
          <section className={styles["msg-contato"]}>
            ...
            <p>
              Se você deseja encomendar delícias artesanais ou tem alguma dúvida,
              fale comigo! Estou aqui para atender você com carinho e açúcar na
              medida certa.
            </p>
            <br />
        ...
        <form onSubmit={simulaEnvie} className={styles.form + " box pad"}>
          <div className={styles.linha + " box row"}>
            <div className={styles.campo + " box"}>
              <label htmlFor="f-nome">Seu nome*</label>
              <input name="nome" type="text" id="f-nome" placeholder="Escreva seu nome" required />
            </div>
            <div className={styles.campo + " box"}>
              <label htmlFor="f-email">Seu E-Mail*</label>
              <input name="mail" type="email" id="f-email" placeholder="email@provedor.com" required />
            </div>
            <div className={styles.campo + " box"}>
              <label htmlFor="f-cel">Seu celular / whatsapp*</label>
              <input name="cel" type="text" id="f-cel" placeholder="19 98888-4444" required />
            </div>
          </div>
          ...
          {/* Simula mensagem de email enviado */}
          {mensagem && <div className="enviado">{mensagem}</div>}
